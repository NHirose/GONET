...
'''
model_file_gen = 'nn_model/dcgan_model_gen_95.h5'
model_file_dis = 'nn_model/dcgan_model_dis_95.h5'
model_file_invg = 'nn_model/dcgan_model_invg_17.h5'
#model_file_fl = 'nn_model/model_RDFresnet_RDF_2600.h5'  #test 98.5
model_file_fl = 'nn_model/model_RDFresnet_RDF_stereo_2200.h5'  #test 98.5
...
class FL(chainer.Chain):
    def __init__(self, wscale=0.02):
        ...
        super(FL, self).__init__(
            l_img = L.Linear(6*128*128, 10, initialW=initializer),
...
if __name__ == '__main__':
    ...
    #subscribe of topics
    #msg1_sub = message_filters.Subscriber('/cv_camera_node1/image1', Image)
    #msg2_sub = message_filters.Subscriber('/cv_camera_node2/image2', Image)
    msg1_sub = message_filters.Subscriber('/cv_camera_node1/image1', Image)
    msg2_sub = message_filters.Subscriber('/cv_camera_node2/image_raw', Image)
    #message filter registration
    ts = message_filters.ApproximateTimeSynchronizer([msg1_sub, msg2_sub], 10, 0.1)
